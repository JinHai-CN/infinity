    ...
    do {
        ...
        auto index_info_list = new std::vector<IndexInfo *>();
        {
...

            {
                ...
                index_param_list->emplace_back(new InitParameter("M", std::to_string(32)));
                index_param_list->emplace_back(new InitParameter("ef_construction", std::to_string(256)));
                index_param_list->emplace_back(new InitParameter("ef", std::to_string(256)));
